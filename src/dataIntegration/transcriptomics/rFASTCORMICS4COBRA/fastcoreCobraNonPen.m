function  A = fastcoreCobraNonPen(model, coreRxnInd, epsilon, printLevel, nonPen)
...
% USAGE:
%
% A = fastcoreCobraNonPen(model, coreRxnInd, epsilon, printLevel, nonPen)
%
% INPUTS:
...
%   nonPen:           cell array with the names of the unpenalized
%                        reactions
% OUTPUT:
%
...
[Supp, ~] = findSparseModeCobra(J, P, singleton, model, LPproblem, epsilon,[],nonPen);
